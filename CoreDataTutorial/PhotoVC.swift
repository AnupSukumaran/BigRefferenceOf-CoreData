...
class PhotoVC: UITableViewController {
    ...
    //MARK: Alert for Error messages
    
    func showAlertWith(title: String, message: String, style: UIAlertControllerStyle = .alert){
        let alertConroller = UIAlertController(title: title, message: message, preferredStyle: style)
    ...
    //to avoid repeation in core data
    ...
    private func saveInCoreDataWith(array: [[String: AnyObject]]){
            ...
            let dataenrtu = array.map{self.createPhotoEntityFrom(dictionary: $0)}
        
        print("DATasSS = \(dataenrtu)")
        do {
